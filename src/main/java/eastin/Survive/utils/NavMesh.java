...
public class NavMesh {
    ...
    public NavMesh(RectangularObject mover, List<RectangularObject> obstacles) {
        ...
        for(RectangularObject r:obstacles) {
            ...
            //bottom left
            nodes.add(new Node(r.getLeftBound() - mover.getWidth(), r.getLowerBound() - mover.getHeight()));

            //top left
            nodes.add(new Node(r.getLeftBound() - mover.getWidth(), r.getUpperBound() + 1));

            //bottom right
            nodes.add(new Node(r.getRightBound() + 1, r.getLowerBound() - mover.getHeight()));

            //top right
            nodes.add(new Node(r.getRightBound() + 1, r.getUpperBound() + 1));
        }
